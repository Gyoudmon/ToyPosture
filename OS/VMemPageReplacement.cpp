...
namespace {
    class GMSlet : public IGraphlet {
        ...
        public:
            bool on_hover(float local_x, float local_y) override {
                return false;
            }

            bool on_tap(float local_x, float local_y) override {
                return false;
            }

            bool on_goodbye(float local_x, float local_y) override {
                return false;
            }
    ...
    class VMemPlanet : public Planet {
        public:
            VMemPlanet() : Planet("Virtual Memory Page Replacement") {}
        ...
        public:
            void load(float width, float height) override {
                ...
                this->label = this->insert_one(new Labellet(game_unicode_font, "内存页面替换算法"));
            }
    ...
    class VMemPageReplacement : public Cosmos {
        ...
        public:
            void construct(int argc, char* argv[]) {
                ...
                this->push_planet(new VMemPlanet());
            }
    };
}
...
int main(int argc, char* args[]) {
    VMemPageReplacement universe(8);
