...
(module unsafe racket/base
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  (define-ffi-definer define-macro-spec (digimon-ffi-lib "macro"))

  (define-macro-spec test_offsetof (_fun _int _symbol -> _int))
  (define-macro-spec test_containerof (_fun _int _symbol -> _int64))

  (define-macro-spec pseudo_address _int64))
...
(module+ main
  ...
  (spec-begin macro
              (describe "offsetof" #:do
                        (context "given `struct { char id; char name[20]; zahlen_t* score; char unused[16]; }`" #:do
                                 (let*/spec ([ptr-sizeof (compiler-sizeof '*)]
                                            ...
                                            (it ["should return ~a for the 3rd member" 3rd-offset] #:do
                                                (expect-= (test_offsetof 2 'score) 3rd-offset))
              ...
              (describe "containerof" #:do
                        (it ["should return 0x~a for the instance" (~r pseudo_address #:base 16)] #:do
                            (expect-0x= (test_containerof 2 'score) pseudo_address)))))
