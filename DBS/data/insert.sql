...
insert into departments(id, name, tel) values (1, N'生命科学', '0511');
insert into departments(id, name, tel) values (2, N'物质科学', '0512');
insert into departments(id, name, tel) values (3, N'空间科学', '0513');
insert into departments(id, name, tel) values (4, N'环境科学', '0514');
...
insert into courses(id, name, period, credit) values (1, N'语文', 50, 6);
insert into courses(id, name, period, credit) values (2, N'数学', 50, 6);
insert into courses(id, name, period, credit) values (3, N'英语', 50, 6);
insert into courses(id, name, period, credit) values (4, N'科学', 20, 4);
