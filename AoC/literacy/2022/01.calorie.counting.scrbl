...
@itemlist[
 ...
 @item{第一个精灵分别带了@racket[1000], @racket[2000] 和 @racket[3000]卡路里的食物，总计 @racket[6000]卡路里。}  
 @item{第二个精灵只带了一种含@racket[4000]卡路里的食物。}
 @item{第三个精灵带了@racket[5000] 和 @racket[6000]卡路里的食物，总计 @racket[11000]卡路里。}
 @item{第四个精灵带了@racket[7000], @racket[8000] 和 @racket[9000]卡路里的食物，总计 @racket[24000] 卡路里。}
 @item{第五个精灵带了一种含@racket[10000]卡路里的食物。}
...
于是，第一题，找到携带卡路里最多的精灵，@bold{它一共带了多少卡路里}？
